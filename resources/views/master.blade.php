...
<head>
 ...
 ============================================= -->
    ...
    <link rel="stylesheet" href="{{ asset('css/colors.php?color=FE9603') }}" type="text/css" /> <!-- Theme Color -->
    <link rel="stylesheet" href="{{ asset('css/seo/css/fonts.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('css/seo/seo.css') }}" type="text/css" />
    <!-- / -->

    <!-- Document Title
 ============================================= -->
    <title>Financia Demo</title>
 ...
 ============================================= -->
                ...
                <div class="row justify-content-between">
                    <div class="col-12 col-md-auto">
                        ...
                        <div class="top-links">
                            <ul class="top-links-container">
                                ...
                                <li class="top-links-item"><a href="#"><img src="demos/seo/images/flags/eng.png"
                                            alt="Lang">Eng</a>
                                    <ul class="top-links-sub-menu">
                                        ...
                                        <li class="top-links-item"><a href="#"><img src="demos/seo/images/flags/tha.png"
                                                    alt="Lang">Thai</a></li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="col-12 col-md-auto dark">
                        ...
                        <ul id="top-social">
                            ...
                            <li><a href="https://instagram.com/semicolonweb" class="si-instagram"
                                    target="_blank"><span class="ts-icon"><i
  ...
  ============================================= -->
            ...
            <div id="header-wrap">
                <div class="container">
                    <div class="header-row">
                        ...
                        <div id="logo">
                            <a href="{{route('newHomepage')}}" class="standard-logo"
                                data-dark-logo="https://financiafx.co/images/logo-ffx-1.png"><img
                                    src="https://financiafx.co/images/logo-ffx-1.png" alt="Canvas Logo"></a>
                            <a href="{{route('newHomepage')}}" class="retina-logo"
                                data-dark-logo="https://financiafx.co/images/logo-ffx-1.png"><img
                                    src="https://financiafx.co/images/logo-ffx-1.png" alt="Canvas Logo"></a>
                        </div><!-- #logo end -->
                        ...
                        {{-- <nav class="primary-menu with-arrows">
                            ...
                            <ul class="menu-container">
                                ...
                                <li class="menu-item"><a class="menu-link" href="demo-seo-about.html">
                                        <div>What We Do</div>
                                    </a></li>
                                    ...
                                    {{-- <div class="mega-menu-content mega-menu-style-2 px-0">
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <a href="demo-seo-social.html"
                                                    class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
                                                    <div class="feature-box">
                                                        <div class="fbox-icon mb-2">
                                                            <img src="demos/seo/images/icons/social.svg"
                                                                alt="Feature Icon" class="bg-transparent rounded-0">
                                                        </div>
                                                        <div class="fbox-content">
                                                ...
                                                <a href="demo-seo-adwords.html"
                                                    class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
                                                    <div class="feature-box">
                                                        <div class="fbox-icon mb-2">
                                                            <img src="demos/seo/images/icons/adword.svg"
                                                                alt="Feature Icon" class="bg-transparent rounded-0">
                                                        </div>
                                                        <div class="fbox-content">
                                                ...
                                                <a href="demo-seo-experience.html"
                                                    class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
                                                    <div class="feature-box">
                                                        <div class="fbox-icon mb-2">
                                                            <img src="demos/seo/images/icons/experience.svg"
                                                                alt="Feature Icon" class="bg-transparent rounded-0">
                                                        </div>
                                                        <div class="fbox-content">
                                                ...
                                                <a href="demo-seo-analysis.html"
                                                    class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
                                                    <div class="feature-box">
                                                        <div class="fbox-icon mb-2">
                                                            <img src="demos/seo/images/icons/analysis.svg"
                                                                alt="Feature Icon" class="bg-transparent rounded-0">
                                                        </div>
                                                        <div class="fbox-content">
                                                ...
                                                <a href="demo-seo-content-marketing.html"
                                                    class="mega-menu-column sub-menu-container col-lg-4 border-bottom h-bg-light py-4">
                                                    <div class="feature-box">
                                                        <div class="fbox-icon mb-2">
                                                            <img src="demos/seo/images/icons/content_marketing.svg"
                                                                alt="Feature Icon" class="bg-transparent rounded-0">
                                                        </div>
                                                        <div class="fbox-content">
                                                ...
                                                <div class="mega-menu-column sub-menu-container col-12 p-0">
                                                    <a href="demo-seo-about.html"
                                                        class="button button-rounded button-large nott ls0 w-100 text-center m-0 rounded-0 py-3 button-light ">View
                                                        All <i class="icon-line-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
        ...
        <footer id="footer" class="border-0 bg-white">
                    ...
                    <div class="row col-mb-50">
                        <div class="col-md-8">
                            ...
                            <div class="widget clearfix">
                                ...
                                <img src="{{ asset('images/logo-ffx.png') }}" alt="Footer Logo" class="alignleft"
                            ...
                            <div class="widget subscribe-widget clearfix">
                                ...
                                <form id="widget-subscribe-form" action="include/subscribe.php" method="post"
                                    ...
                                    <div class="input-group mx-auto">
                                        <div class="input-group-text bg-transparent"><i class="icon-email2"></i>
                                        </div>
                                        <input type="email" id="widget-subscribe-form-email"
                                            name="widget-subscribe-form-email" class="form-control required email"
                                            placeholder="Enter your Email">
                                        <button class="btn btn-success button button-color nott ls0 m-0"
            ...
            <!-- Copyrights -->
            <div id="copyrights"
                style="background: url('demos/seo/images/hero/footer.svg') no-repeat top center; background-size: cover; padding-top: 70px;">
                <div class="container clearfix">

                    <div class="row justify-content-between col-mb-30">
                        <div class="col-12 col-lg-auto text-center text-lg-start">
                            Copyrights &copy; 2022 Powered by Yokesen<br>
